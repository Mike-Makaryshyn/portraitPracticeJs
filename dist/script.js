...
var accordion = function accordion(triggersSelector) {
  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      //скрываем просмотренные разделы.  
      btns.forEach(function (btn) {
  ...
  }); // 2 Спсоб ( при помощи css классов)
...
var drop = function drop() {
  ...
  function highlight(item) {
    item.closest('.file_upload').style.border = "2px solid rebeccapurple";
    item.closest('.file_upload').style.backgroundColor = "rgb(89, 92, 92,0.5)";
  }
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      statusImg.classList.add('animaned', 'fadeInUp');
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  function createCards(response) {
    response.forEach(function (_ref) {
      ...
      card.classList.add('animated', 'bounceInUp', 'col-sm-3', 'col-sm-offset-0', 'col-xs-10', 'col-xs-offset-1');
...
/* harmony default export */ __webpack_exports__["default"] = (showMoreStyles); // 2 способ, если заданы класси, просто переключать их по клику. Первый способ получать данные с сервера.
// cards.forEach(card => {
